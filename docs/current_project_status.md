...
- PR #197 tooling: add PR gate task-draft generator — reads classifier packet and optional EXECUTOR_PACKET.json, produces PR_GATE_TASK_DRAFT.json/md with idempotent action mapping; does NOT call LLMs, does NOT call GitHub APIs directly, does NOT create Kanban tasks — **in review**
