...
- PR #193 tooling: add read-only AED Tasker input collector — collects structured internal repo context (HEAD, branch, docs/scripts/tests/schemas presence, recent commits) for future Tasker agent; no LLM calls, no network, no Kanban ops — **in review**
