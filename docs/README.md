...
- PreEarningsProfile v1 design complete (PR #130)
...
- PreEarningsProfile v1 **design complete** (PR #130): design document only; schema, fixtures, validator, tests, CI wiring deferred
